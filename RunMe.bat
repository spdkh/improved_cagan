...
python -m train --dnn_type RCAN --data_dir D:\Data\FixedCell\PFA_eGFP\cropped3d_128_3 --batch_size 8 --n_ResGroup 2 --n_RCAB 10 --epoch 500 --start_lr 1e-3 --lr_decay_factor 0.5 --d_start_lr 1e-6 --d_lr_decay_factor 0.5 --mae_loss 1 --alpha 0 --beta 0 --mse_loss 0 --unrolling_iter 0