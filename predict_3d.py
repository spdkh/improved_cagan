...
parser.add_argument("--model_weights", type=str, default="../trained_models/3d/caGAN3D-SIM_cropped_old/weights_best.h5")
...
optimizer = optimizers.Adam(learning_rate=1e-5, decay=0.5)
