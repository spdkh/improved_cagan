...
def parse_args():
    ...
    parser.add_argument('--epoch', type=int, default=default_iterations, help='The number of epochs to run')
    parser.add_argument("--sample_interval", type=int, default=default_iterations // 50)
    parser.add_argument("--validate_interval", type=int, default=default_iterations // 25)
    parser.add_argument("--validate_num", type=int, default=default_iterations // 25)

    # Generator Setup
    parser.add_argument("--start_lr", type=float, default=1e-4)  # 1e-4
    ...
    parser.add_argument("--d_lr_decay_factor", type=float, default=0.9)
